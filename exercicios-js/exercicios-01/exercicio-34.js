...
console.log(verificacaoDeString('eabc', 'abcae'))
console.log(verificacaoDeString('abc', 'Def'))

// charAt() -> retorna o caractere na posição indicada
// toLowerCase() -> converte a string para minúscula ou maiúscula.
